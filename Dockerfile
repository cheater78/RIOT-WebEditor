...
ARG SRC_RIOT_SHELL="./src/riot_web_term.py"
...
ENV RIOT_SHELL="${RIOT_WEB_RUNTIME_DIRECTORY}/riot_web_term.py"
COPY --chown=$USERID:$GROUPID --chmod=777 "${SRC_RIOT_SHELL}" "${RIOT_SHELL}"
ENV SHELL=$RIOT_SHELL
